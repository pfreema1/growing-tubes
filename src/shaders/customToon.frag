...
#define SHADER_NAME MeshToonMaterial
#define TOON 
...
void main() {
    ...
    IncidentLight directLight;
        ...
        getPointDirectLightIrradiance( pointLight, geometry, directLight );
            ...
            directLight.color *= all( bvec3( pointLight.shadow, directLight.visible, receiveShadow ) ) ? getPointShadow( pointShadowMap[ 0 ], pointLight.shadowMapSize, pointLight.shadowBias, pointLight.shadowRadius, vPointShadowCoord[ 0 ], pointLight.shadowCameraNear, pointLight.shadowCameraFar ) : 1.0;
        #endif
